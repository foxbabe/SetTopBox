...
//    }
//
//    public AtvChannel[] getAllProgramInfoT() {
//        AtvChannel[] progList = new AtvChannel[10];
//        for (int i = 0; i < 10; i++) {
//            progList[i] = new AtvChannel();
...
//    }
//
//    public AtvChannel[] getAllProgramInfo() {
////        int count = getAtvProgramCount();
////        AtvChannel[] progList = new AtvChannel[count];
////
////        ChannelManager cm = TvManager.getChannelManager();
////        AtvScanManager asm = AtvManager.getAtvScanManager();
////        for (int i = 0; i < count; i++) {
////            AtvChannel pi = new AtvChannel();
////            pi.setChennalNum(i);
////
...
//    }
//
//    private AtvChannel getProgramInfo(int index) {
//        AtvChannel info = new AtvChannel();
...
//    }
//
//    private boolean writeToDatabase(AtvChannel[] progList) {
...
//    }
//
//    private AtvChannel readDatabase(int index) {
//
//        AtvChannel p = new AtvChannel();
//
//
//        AtvScanManager asm = AtvManager.getAtvScanManager();
//        AudioManager am = TvManager.getAudioManager();
...
//        AtvChannel[] oldlist = getAllProgramInfo();
//        ArrayList<AtvChannel> newlist = new ArrayList<AtvChannel>(Arrays.asList(oldlist));
//        AtvChannel p = getProgramInfo(6);
//        p.setChennalNum(newlist.size());
//        newlist.add(p);
//
////		for (AtvChannel info : newlist) {
...
////		}
//
//        writeToDatabase(newlist.toArray(new AtvChannel[newlist.size()]));
//    }
//
...
////            return;
////
////        writeToDatabase(programResponse.getTvChannelList().toArray(new AtvChannel[programResponse.getTvChannelList().size()]));
