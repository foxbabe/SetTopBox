...
//        mFirstIPTv.addTextChangedListener(new TextWatcher() {
//
//            @Override
...
//        });
//
//        mSecondIPTv.addTextChangedListener(new TextWatcher() {
//
//            @Override
//            public void onTextChanged(CharSequence s, int start, int before,
//                                      int count) {
...
//
//
//        mThirdIPTv.addTextChangedListener(new TextWatcher() {
//
//            @Override
//            public void onTextChanged(CharSequence s, int start, int before,
//                                      int count) {
...
//        });
//
//        mFourthIPTv.addTextChangedListener(new TextWatcher() {
//
//            @Override
//            public void onTextChanged(CharSequence s, int start, int before,
//                                      int count) {
...
//                            Toast.makeText(getContext(), "每一段IP不能大于255", Toast.LENGTH_SHORT)
//                                    .show();
//                            return;
//                        }
//                    } catch (NumberFormatException e) {
