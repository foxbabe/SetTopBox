 ...
 */
public class KeyCodeConstantGiec {
     ...
     * （电视/广播 按钮）
     */
    public static final int KEY_CODE_CHANGE_SIGNAL = 175;
    /**
     * 切换 广告/电视 模式
     */
     ...
     * （HOME 按钮）
     */
    public static final int KEY_CODE_SETTING = 169;
    /**
     * 弹出电视频道列表
     * （确定 按钮）
     */
     ...
     * （电脑 按钮）
     */
    public static final int KEY_CODE_AV_IN = 184;
    /**
     * 切换电视输入源为ANT IN
     * （电视 按钮）
     */
    public static final int KEY_CODE_ANT_IN = 183;
    /**
     * 切换电视输入源为HDMI IN
     * （电影 按钮）
     */
    public static final int KEY_CODE_HDMI_IN = 185;
    /**
     * 上传频道信息
     * （频道+ 按钮）
     */
